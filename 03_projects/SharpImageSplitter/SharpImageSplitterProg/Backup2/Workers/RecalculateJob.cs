...
//
// internal class RecalculateJob3
// { 
...
//
//         _info.PositionsDict = new Dictionary<int, int[]>();
...
//     {
//         int startOfTopHeight = GetBigHeightPos(i); 
//         int startOfMiddleHeight = GetSmallHeightPos(i);
//         int startOfBottomHeight = GetBigHeightPos(i) + GetCropHeight(i);
//         int endHeight = startOfBottomHeight + _info.Strap;
//         int topStrap = startOfMiddleHeight - startOfTopHeight;
//         int bottomStrap = endHeight - startOfBottomHeight;
...
//     }
//
//     public Rectangle RectangleByPositionIntDict(
//         int i,
//         SplitInfo splitInfo)
//     {
...
//             _info.Wmax,
//             cropHeight);
//         splitInfo.RectanglesArray[i] = rectangle;
//         return rectangle;
//     }
// }
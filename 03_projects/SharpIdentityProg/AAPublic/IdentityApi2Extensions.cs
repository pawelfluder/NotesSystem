...
public static class IdentityApiExtensions
{
    ...
    public static IEndpointConventionBuilder MapIdentityApi2<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{"MapIdentityApi"}-{finalPattern}";

using System;
using System.IO;
using SharpFileServiceProg.Operations.Yaml.TypeConverter;
using SharpFileServiceProg.Service;
using YamlDotNet.Serialization;

namespace SharpFileServiceProg.Operations.Yaml
{
    internal class Custom02YamlOperations : FileService.IYamlOperations
    {
        ...
        bool FileService.IYamlOperations.TryDeserialize<T>(string yamlText, out T result)
        {

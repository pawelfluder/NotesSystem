...
public interface INoSqlAddressOperations2
{
    ...
    public static (string, string) JoinIndexWithLoca(
        (string Repo, string Loca) adrTuple, int? index)
    {
        ...
        var idxString = IFrontendOperations.TwoDigitsStr
            .FromInt(index);

        var newLoca = IFrontendOperations.NoSqlAddress
            .JoinLoca(adrTuple.Loca, idxString);
